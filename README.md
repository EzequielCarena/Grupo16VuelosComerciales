...
El último paso fue el análisis y comprensión de los datos obtenidos para estudio futuro y visualización de los mismos. La herramienta principal a utilizar fue POWER BI, con algunas intervenciones de GOOGLE SLIDES durante el crecimiento del proyecto.
